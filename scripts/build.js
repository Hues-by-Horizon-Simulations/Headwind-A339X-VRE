...
const LIVERY_SRC = path.resolve(__dirname, '..', 'hues-a339x-vre/src');
const LIVERY_OUT = path.resolve(__dirname, '..', 'hues-a339x-vre/out');
...
createPackageFiles(path.resolve(LIVERY_OUT, 'hues-livery-a339x-aircotedivoire-package'), 'manifest-base.json');
